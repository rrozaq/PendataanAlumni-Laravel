            ...
            @endif
              ...
              @endif
                ...
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    <br />
                    <form class="form-horizontal form-label-left" action="{{route('alumni.update', ['npm'=>$student->npm])}}" method="POST">
                        @csrf
                    <input type="hidden" value="PUT" name="_method">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-2 col-sm-2 col-xs-4">
                          <input type="text" id="npm" name="npm" required="required" class="form-control col-md-7 col-xs-12" value="{{ old('npm') ?: $student->npm }}">
                        </div>
                      </div>
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" id="nama" name="nama_0152" required="required" class="form-control col-md-7 col-xs-12" value="{{ old('nama') ?: $student->nama_0152 }}">
                        </div>
                      </div>
                      <div class="form-group">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input id="email" class="form-control col-md-7 col-xs-12" required="required" name="email" type="email"  value="{{ old('email') ?: $student->email }}">
                        </div>
                      </div>
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input id="hp" class="form-control col-md-7 col-xs-12" required="required" name="hp" type="text" value="{{ old('hp') ?: $student->hp }}">
                        </div>
                      </div>
                      <div class="form-group">
                        ...
                        <div class="col-md-2 col-sm-2 col-xs-5">
                          <input id="tempat_lahir" class="form-control col-md-7 col-xs-12" required="required" name="tempat_lahir" type="text" value="{{ old('tempat_lahir') ?: $student->tempat_lahir }}">
                        </div>
                        <div class="col-md-2 col-sm-2 col-xs-5">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-5 col-sm-5 col-xs-5">
                          <textarea id="alamat_asal" required="required" class="form-control" name="alamat_asal">{{ $student->alamat_asal }}</textarea>
                        </div>
                        </div>
                        <div class="form-group">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-5 col-sm-5 col-xs-5">
                        <input id="slta_asal" class="form-control col-md-7 col-xs-12" required="required" type="text" name="slta_asal" value="{{ old('slta_asal') ?: $student->slta_asal }}">
                        </div>
                        </div>
                        <div class="form-group">
